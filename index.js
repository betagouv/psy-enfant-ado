...
app.use(
  ...
  express.static(path.join(__dirname, "node_modules/@gouvfr/dsfr/dist"), {
    setHeaders: setNoIndexHeaders,
  })
);
app.use(
  "/static/polyfill",
  express.static(path.join(__dirname, "node_modules/promise-polyfill/dist"), {
    setHeaders: setNoIndexHeaders,
  })
);
...
app.use((req, res, next) => {
  ...
  res.locals.appDescriptionFull =
    `${appDescription} Le « forfait 100% psy enfants » donne accès à 10 séances de ` +
